  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent='center' p="20px">
        ...
        <Box position="relative" mb="72px">
            ...
            }} placeholder='Searh Exercises' type="text"/>
        ...
        <Box sx={{positin:"relative", width:"100%", p:"20px"}}>
            <HorizontalScrollBar bodyParts={bodyParts} data={bodyParts} bodyPart={bodyPart} setBodyPart={setBodyPart}/>
        </Box>
    </Stack>
  )
}
